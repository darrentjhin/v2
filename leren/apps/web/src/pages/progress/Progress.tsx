  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      {data.timeseries.length > 0 && (
        <div className="card">
          <h2 className="font-semibold mb-4">Attempts over time</h2>
      ...
      {data.weakTopics.length > 0 && (
        <div className="card">
          <h2 className="font-semibold mb-3">Needs work</h2>
      ...
      {data.total === 0 && <div className="text-slate-500 text-center py-12">No practice attempts yet. Go to Practice to get started.</div>}
    </div>
  );
}
